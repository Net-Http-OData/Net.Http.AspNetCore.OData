...
namespace Net.Http.AspNetCore.OData
{
    ...
    public static class ODataHttpRequestExtensions
    {
        ...
        public static string ODataContext(this HttpRequest request)
        {
            if (request is null)
            {
        ...
        /// <returns>A <see cref="string"/> containing the @odata.context, or null if the metadata for the request is none.</returns>
        public static string ODataContext(this HttpRequest request, EntitySet entitySet)
        {
            if (request is null)
            {
                throw new ArgumentNullException(nameof(request));
        ...
        public static string ODataContext(this HttpRequest request, EntitySet entitySet, SelectExpandQueryOption selectQueryOption)
        {
            if (request is null)
            {
                throw new ArgumentNullException(nameof(request));
        ...
        /// <returns>A <see cref="string"/> containing the @odata.context, or null if the metadata for the request is none.</returns>
        public static string ODataContext<TEntityKey>(this HttpRequest request, EntitySet entitySet)
        {
            if (request is null)
            {
                throw new ArgumentNullException(nameof(request));
        ...
        /// <typeparam name="TEntityKey">The type of entity key.</typeparam>
        /// <returns>A <see cref="string"/> containing the @odata.context URI, or null if the metadata for the request is none.</returns>
        public static string ODataContext<TEntityKey>(this HttpRequest request, EntitySet entitySet, TEntityKey entityKey, string propertyName)
        {
            if (request is null)
            {
                throw new ArgumentNullException(nameof(request));
        ...
        public static EntitySet ODataEntitySet(this HttpRequest request)
        ...
        public static string ODataId<TEntityKey>(this HttpRequest request, EntitySet entitySet, TEntityKey entityKey)
        {
            if (request is null)
            {
                throw new ArgumentNullException(nameof(request));
        ...
        public static string ODataNextLink(this HttpRequest request, ODataQueryOptions queryOptions, int skip, int resultsPerPage)
        {
            if (request is null)
            {
                throw new ArgumentNullException(nameof(request));
        ...
        public static ODataRequestOptions ODataRequestOptions(this HttpRequest request)
        ...
        {
            if (request.Query.TryGetValue("$format", out StringValues formatQueryString))
            {
                foreach (string formatQueryParameters in formatQueryString)
                {
        ...
        internal static ODataVersion ReadODataMaxVersion(this HttpRequest request)
        {
        ...
        internal static ODataVersion ReadODataVersion(this HttpRequest request)
        {
